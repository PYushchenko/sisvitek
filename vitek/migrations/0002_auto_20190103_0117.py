...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transaction_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='vitek.Transaction')),
            ],
            bases=('vitek.transaction',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='transaction',
            name='place_from',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transfers_from', to='vitek.Place'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='place_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transfers_to', to='vitek.Place'),
        ),
    ]
